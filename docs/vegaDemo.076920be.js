...
function drawBarVegaLite() {
  ...
  vl.markBar({
    filled: true,
    color: 'teal'
  }).data(sunshineArray).encode(vl.x().fieldN('month').sort('none'), vl.y().fieldQ('sunshine'), vl.tooltip(['sunshine'])).width(390).height(390).render().then(function (viewElement) {
...
//# sourceMappingURL=https://cse412.github.io/project-demo/vegaDemo.076920be.js.map