...
module.exports = "https://cse412.github.io/project-demo/sunshine.71fb7d0b.csv";
},{}],"Edg9":[function(require,module,exports) {
"use strict";
...
var legendSpace = 130; // preparation for our x/y axis
...
function drawLineD3() {
  ...
  line_svg.append("g").attr("class", "myYaxis").call(yAxis); // make a line for each city
  ...
  citySet.forEach(function (d) {
    ...
    var path = line_svg.append("path").datum(currentCity).attr("class", "lines").attr('d', line).style("stroke-width", 2.5).style("fill", "none").attr("stroke", colorSet(d));
  }); // add legend
...
},{"../static/sunshine.csv":"ZQwg"}]},{},["Edg9"], null)
//# sourceMappingURL=https://cse412.github.io/project-demo/d3-demo.3cfb303b.js.map