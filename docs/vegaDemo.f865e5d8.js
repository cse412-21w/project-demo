...
function drawBarVegaLite() {
  vl.markBar({
    filled: true,
    color: "teal"
  }).data(sunshineArray).encode(vl.x().fieldN('month').sort('none'), vl.y().fieldQ('sunshine'), vl.tooltip('sunshine')).width(500).height(500).render().then(function (viewElement) {
    document.getElementById('view').appendChild(viewElement);
  });
}
},{"../static/sunshine.csv":"ZQwg"}]},{},["CsaW"], null)
//# sourceMappingURL=https://cse412-21w.github.io/project-demo/vegaDemo.f865e5d8.js.map